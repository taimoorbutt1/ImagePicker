package com.taimoor.imagepicker.provider
...
import com.taimoor.imagepicker.ImagePicker
import com.taimoor.imagepicker.ImagePickerActivity
import com.taimoor.imagepicker.util.ExifDataCopier
import com.taimoor.imagepicker.util.FileUtil
import com.taimoor.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.taimoor.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
